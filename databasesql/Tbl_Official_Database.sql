...
--
-- Host: localhost
-- Generation Time: Dec 11, 2024 at 04:33 AM
...
--
-- Table structure for table `Tbl_Official_Summaries`
--

CREATE TABLE `Tbl_Official_Summaries` (
  `Schedule_ID` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
  `teacher_id` int(11) NOT NULL,
  `room_id` int(11) NOT NULL,
...
--
-- Dumping data for table `Tbl_Official_Summaries`
--

INSERT INTO `Tbl_Official_Summaries` (`Schedule_ID`, `subject_id`, `teacher_id`, `room_id`, `status_id`, `weekday_id`, `time_id`, `student_id`) VALUES
(2, 7, 14, 2, 1, 1, 1, 4),
(3, 1, 1, 3, 1, 1, 6, 1),
(4, 2, 1, 2, 1, 1, 6, 4);
...
--
-- Indexes for table `Tbl_Official_Summaries`
--
ALTER TABLE `Tbl_Official_Summaries`
  ADD KEY `Schedule_ID` (`Schedule_ID`),
  ADD KEY `subject_id` (`subject_id`,`teacher_id`,`room_id`),
  ADD KEY `status_id` (`status_id`,`weekday_id`,`time_id`),
  ADD KEY `student_ids` (`student_id`),
  ADD KEY `student_id` (`student_id`);
...
--
-- Constraints for table `Tbl_Official_Summaries`
--
ALTER TABLE `Tbl_Official_Summaries`
  ADD CONSTRAINT `Tbl_Official_Summaries_ibfk_1` FOREIGN KEY (`Schedule_ID`) REFERENCES `Tbl_Official_Final_Schedule` (`Schedule_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Tbl_Official_Summaries_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `Tbl_Official_Students` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
