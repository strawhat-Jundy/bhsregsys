...
/**
 * TblOfficialRoomTableSearch represents the model behind the search form of `frontend\models\TblOfficialRoomTable`.
 */
class TblOfficialRoomTableSearch extends TblOfficialRoomTable
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = TblOfficialRoomTable::find();
