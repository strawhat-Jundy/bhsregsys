...
/**
 * StudentTableSearch represents the model behind the search form of `frontend\models\TblOfficialStudents`.
 */
class StudentTableSearch extends TblOfficialStudents
{
    /**
     * {@inheritdoc}
     */
