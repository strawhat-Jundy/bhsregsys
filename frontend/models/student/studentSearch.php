...
namespace frontend\models\student;
...
/**
 * studentSearch represents the model behind the search form of `frontend\models\BalingasaHighSchoolStudents`.
 */
class studentSearch extends BalingasaHighSchoolStudents
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = BalingasaHighSchoolStudents::find();
