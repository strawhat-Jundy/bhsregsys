...
<style>
    ...
    .balingasa-high-school-subjects-view .btn {
        color: #001840;
        border: none;
        padding: 10px 20px;
        border-radius: 20px;
    ...
    .balingasa-high-school-subjects-view .btn-primary {
        background-color: #f2f8fc;
        color: #001840;
    }

    .balingasa-high-school-subjects-view .btn-primary:hover {
        background-color: #f5c400;
        color: #001840;
    }

    .balingasa-high-school-subjects-view .btn-danger {
        background-color: #001840;
        color: #f2f8fc;
    }

    .balingasa-high-school-subjects-view .btn-danger:hover {
        background-color: #f5c400;
        color: #001840;
    }

    /* Styling for the DetailView widget */
    .balingasa-high-school-subjects-view .detail-view {
        width: 100%;
    ...
    .balingasa-high-school-subjects-view table {
        background-color: #001840;
        color: white;
        text-align: center;
        font-weight: bold;
    ...
    .balingasa-high-school-subjects-view th,
    .balingasa-high-school-subjects-view td {
        background-color: #001840;
        color: white;
        text-align: center;
        font-weight: bold;
