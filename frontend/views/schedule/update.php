...
<style>
    ...
    .tbl-official-final-schedule-update form {
    ...
    .tbl-official-final-schedule-update input,
    .tbl-official-final-schedule-update select,
    .tbl-official-final-schedule-update textarea {
    ...
    /* Change button color */
    .tbl-official-final-schedule-update .form-group button {
    ...
    /* Button hover effect */
    .tbl-official-final-schedule-update .form-group button:hover {
