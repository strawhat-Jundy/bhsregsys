...
<body>
    ...
    <main>
        <div id="hero">
            <div class="hero-text">
                ...
                <button class="btn-yellow learn">Learn more</button>
            </div>
            <div class="hero-img">
            </div>
        </div>
        ...
        <div id="people">
            ...
            <div class="card-container">
                <div class="card card1">
                    <img src="/images/cholo-card.png" alt="Van Cholo Esguerra">
                    <div class="links">
                ...
                <div class="card card2">
                    <img src="/images/cudia-card.png" alt="Lucky Vincent Cudia">
                    <div class="links">
                ...
                <div class="card card3">
                    <img src="/images/ken-card.png" alt="Julius Peralta">
                    <div class="links">
                        <a href="#" target="_blank"><i class="ri-facebook-fill"></i></a>
                    </div>
                </div>
                <div class="card card4">
                    <img src="/images/rogon-card.png" alt="Leonel Rogon">
                    <div class="links">
                ...
                <div class="card card5">
                    <img src="/images/ken-card.png" alt="Kenneth Apolong">
                    <div class="links">
                        <a href="#" target="_blank"><i class="ri-facebook-fill"></i></a>
                    </div>
                </div>
            ...
            <div class="card-container">
                <div class="card card1">
                    <img src="/images/toledo-card.png" alt="Hillary Mhyles Toledo">
                    <div class="links">
                ...
                <div class="card card2">
                    <img src="/images/elaiza-card.png" alt="Elaize Rosario">
                    <div class="links">
                ...
                <div class="card card4">
                    <img src="/images/eloisa-card.png" alt="Eloisa Rosario">
                    <div class="links">
                ...
                <div class="card card5">
                    <img src="/images/erin-card.png" alt="Erin Alonzo">
                    <div class="links">
    ...
    <footer>
        <div class="footer-container">
            <div class="logo-foot">
                <img src="/images/logo.png" alt="Balingasa Higb School Registry System">
            </div>
